...
class CFMock
{
    ...
    {        
        ...
        {
            $called = 0;
            //$matchingFixture = $this->resolveMatchingMethod ( $this->methodName, $this->args );
            ...
            if ( ($fixture->MaximumCallCount !== null && $fixture->Called > $fixture->MaximumCallCount) )
            {
                ...
                //$this->addResult ( $key, $message, false );
            }
    ...
    protected function addResult ( $index, $message, $result )
    {
        ...
        /*
        $testResult = CFTestResultCollection::GetResult ( $this->currentTestCase, $index );
    ...
    protected function addMethodChain ( $method )
    {
        ...
        //$testResult = CFTestResultCollection::GetResult ( $this->currentTestCase, $this->testIndex-1 );
        //$testResult->MethodChain[] = $method;
    }
